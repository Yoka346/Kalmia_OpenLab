...
namespace Kalmia_OpenLab.View.Scenes
{
    partial class DifficultySelectionScene
    {
        ...
        SelectMenu<Difficulty> selectMenu;
        ...
        void InitializeComponent()
        {
            ...
            // Select menu
            this.selectMenu = new SelectMenu<Difficulty>(this.Width / 3, this.Height / 5, this.Width / 3, (int)(this.Height - this.Height * 0.6));
            ...
            this.descriptionLabel = new TransparentLabel
            {
                ...
                Font = new Font(GlobalConfig.Instance.DefaultFontFamily, (int)(this.Height * 0.040), GraphicsUnit.Pixel),
                TextAlign = ContentAlignment.MiddleCenter
            };
