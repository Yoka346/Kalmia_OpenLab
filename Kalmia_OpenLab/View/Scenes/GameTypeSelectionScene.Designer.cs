...
{
    partial class GameTypeSelectionScene
    {
        ...
        void InitializeComponent()
        {
            ...
            // Select menu
            this.selectMenu = new SelectMenu<string>(this.Width / 3, this.Height / 6, this.Width / 3, (int)(this.Height - this.Height * 0.6));
            this.selectMenu.AddItemRange(["普通のオセロ", "最弱オセロ"]);
